...
Begin VB.Form FrmMantPaises 
   ...
   Begin VB.CommandButton Bt_Print 
      ...
      Height          =   855
      Left            =   7980
      Picture         =   "FrmMantPaises.frx":000C
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton Bt_Del 
      ...
      Height          =   855
      Left            =   7980
      Picture         =   "FrmMantPaises.frx":063B
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton Bt_CopyExcel 
      ...
      Height          =   855
      Left            =   7980
      Picture         =   "FrmMantPaises.frx":0C9D
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.Label la_LinkAduana2 
      ...
      Height          =   225
      Left            =   1080
      MouseIcon       =   "FrmMantPaises.frx":1252
   ...
   Begin VB.Image Image1 
      Height          =   690
      Left            =   240
      Picture         =   "FrmMantPaises.frx":13A4
      Top             =   540
      Width           =   690
   End
End
Attribute VB_Name = "FrmMantPaises"
...
Private Sub Bt_Aceptar_Click()
   ...
   For i = 1 To Grid.rows - 1
      ...
      If Grid.TextMatrix(i, C_NOMBRE) <> "" Then
         ...
         If Grid.TextMatrix(i, C_CODIGO) <> "" And Val(Grid.TextMatrix(i, C_CODIGO)) <= 0 Then ' se verifica que no pongan 000
...
'   la_LinkAduana2.Tag = "https://www.aduana.cl/aduana/site/artic/20080218/pags/20080218165942.html#vtxt_cuerpo_T9"
         ...
         For r = Grid.FixedRows To Grid.rows - 1
            If (Grid.TextMatrix(r, C_UPDATE) <> "" Or Grid.TextMatrix(r, C_ID) <> "") And Grid.RowHeight(r) > 0 Then
               If r <> Row And StrComp(Value, Grid.TextMatrix(r, C_CODIGO), vbTextCompare) = 0 Then
                  MsgBox1 "Este Código de País ya existe.", vbExclamation
                  Call FGrSelRow(Grid, Row)
                  Action = vbRetry
                  Exit Sub
               End If
